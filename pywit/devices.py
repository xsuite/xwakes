...
def shunt_impedance_flat_taper_stupakov_formula(half_gap_small: float, half_gap_big: float, taper_slope: float,
                                                half_width: float, cutoff_frequency: float, comp: str=None):
    """
...
def create_flat_taper_stupakov_formula_component(plane: str, exponents: Tuple[int, int, int, int],
                                                 half_gap_small: float, half_gap_big: float, taper_slope: float,
                                                 half_width: float, cutoff_frequency: float, comp: str=None):
    """
    ...
    r_shunt = shunt_impedance_flat_taper_stupakov_formula(half_gap_small=half_gap_small, half_gap_big=half_gap_big,
                                                          ...
                                                          half_width=half_width, cutoff_frequency=cutoff_frequency,
                                                          comp=comp)
